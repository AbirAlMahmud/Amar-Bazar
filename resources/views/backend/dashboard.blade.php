                        ...
                        <div class="card top-selling overflow-auto">
                            ...
                            <div class="card-body pb-0">
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row"><a href="{{ asset('ui/backend') }}/#"><img
                                                        src="{{ asset('ui/backend') }}/assets/img/product-1.jpg"
                                                        alt=""></a></th>
                                            <td><a href="{{ asset('ui/backend') }}/#" class="text-primary fw-bold">Ut
                                                    inventore ipsa voluptas
                                                    nulla</a></td>
                                            <td>$64</td>
                                        ...
                                        <tr>
                                            <th scope="row"><a href="{{ asset('ui/backend') }}/#"><img
                                                        ...
                                                        alt=""></a></th>
                                            <td><a href="{{ asset('ui/backend') }}/#" class="text-primary fw-bold">Sit
                                                    unde debitis delectus
                                                    repellendus</a></td>
                                            <td>$79</td>
                ...
                <div class="card">
                    <div class="filter">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <li><a class="dropdown-item" href="{{ asset('ui/backend') }}/#">Today</a></li>
                            <li><a class="dropdown-item" href="{{ asset('ui/backend') }}/#">This Month</a></li>
                            <li><a class="dropdown-item" href="{{ asset('ui/backend') }}/#">This Year</a></li>
                        </ul>
                    </div>
                        ...
                        <div class="activity">
                            ...
                            <div class="activity-item d-flex">
                                ...
                                <div class="activity-content">
                                    Quia quae rerum <a href="{{ asset('ui/backend') }}/#"
                            ...
                            <div class="activity-item d-flex">
                                ...
                                <div class="activity-content">
                                    Tempore autem saepe <a href="{{ asset('ui/backend') }}/#"
                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="news">
                            <div class="post-item clearfix">
                                ...
                                <h4><a href="{{ asset('ui/backend') }}/#">Nihil blanditiis at in nihil autem</a>
                                </h4>
                            ...
                            <div class="post-item clearfix">
                                ...
                                <h4><a href="{{ asset('ui/backend') }}/#">Quidem autem et impedit</a></h4>
                            ...
                            <div class="post-item clearfix">
                                ...
                                <h4><a href="{{ asset('ui/backend') }}/#">Id quia et et ut maxime similique
                                        occaecati ut</a></h4>
                            ...
                            <div class="post-item clearfix">
                                ...
                                <h4><a href="{{ asset('ui/backend') }}/#">Laborum corporis quo dara net para</a>
                                </h4>
                            ...
                            <div class="post-item clearfix">
                                ...
                                <h4><a href="{{ asset('ui/backend') }}/#">Et dolores corrupti quae illo quod
                                        dolor</a></h4>
